...
Preserve the MIT license and all included copyright/third-party notices. Task contributions and linked source material retain their separately stated terms. Source links currently identify the existing project; update them after the replacement public repository exists.
