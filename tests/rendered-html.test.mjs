...
assert.match(partialHtml,/Reviewed · completion not established/);assert.doesNotMatch(partialHtml,/Reviewed · awaiting acceptance/);assert.match(partialHtml.replace(/<!--.*?-->/g,''),/Criteria: partial/);
